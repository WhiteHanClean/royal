    ...
    return (
        <div className={s.callBackButtonWrapper} style={{ bottom: '16%', right: '2%', zIndex: '100' }} onClick={() => setModal(!modal)}>
            <div className={modal ? s.callBackButtonWrapperInner : classNames(s.callBackButtonWrapperInner, s.overflow_visible)}>
                <a className={modal ? s.socialBtn : classNames(s.socialBtn, s.activeSocialIcons)} style={{ background: 'rgb(191 161 6)' }} href="tel:+996 706 111 444" >
                ...
                <a className={modal ? s.socialBtn : classNames(s.socialBtn, s.activeSocialIcons)} style={{ background: 'rgb(191 161 6)' }} data-toggle="modal" href='https://api.whatsapp.com/send/?phone=996556111444&text=Здравствуйте,&type=phone_number&app_absent=0' data-target="#messageModal">
                ...
                <a className={modal ? s.socialBtn : classNames(s.socialBtn, s.activeSocialIcons)} style={{ background: 'rgb(191 161 6)' }} href="https://www.instagram.com/direct/t/340282366841710300949128328353147599504">
