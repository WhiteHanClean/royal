...
const CallBack = () => {
    ...
    return (
        ...
        <div className={modal ? s.callBackButtonWrapperInner : classNames(s.callBackButtonWrapperInner, s.overflow_visible)}>
            ...
            <a className={ modal ? s.socialBtn : classNames(s.socialBtn , s.activeSocialIcons)} style={{background: 'rgb(191 161 6)' }} data-toggle="modal" href='https://api.whatsapp.com/send/?phone=996556111444&text&type=phone_number&app_absent=0' data-target="#messageModal">
            ...
            <a className={ modal ? s.socialBtn : classNames(s.socialBtn , s.activeSocialIcons)} style={{background: 'rgb(191 161 6)' }} href="https://www.instagram.com/royal.kg_/?igshid=YmMyMTA2M2Y%3D">
