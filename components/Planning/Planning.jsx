            ...
            <div className={styles.wrapper} id='planning'>
                ...
                <div className={styles.selector}>
                    <svg width="4098" height="2332" viewBox="0 0 4098 2332" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M2291.5 1711L2293 471L2312 363H2373.5L2396.5 248.5L3052.5 250.5L3060.5 834.5L3052 1782.5H2857V1763L2592 1761V1783L2395 1781.5L2393.5 1711H2291.5Z" fill="black" fillOpacity="0.5" />
                        <path d="M639.5 1781V241L1296.5 242.5L1345.5 359.5H1407L1448.5 468L1446 1711H1301V1781.5L1105.5 1782.5V1761L835.5 1760V1782.5L639.5 1781Z" fill="black" fillOpacity="0.5" />
                    </svg>
                ...
                <Modal open={isVisibleStageModal} footer={null} width={'100%'} onCancel={() => setIsVisibleStageModal(false)} className={styles.stageModal}>
                    <div className={styles.stageModal}>
                        <div className={styles.selector}>
                            <svg width="7947" height="5762" viewBox="0 0 7947 5762" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path onClick={(e) => handleChooseFlat(!isVisible, e)} className={styles.path} onMouseEnter={handleChangeCurrentStage} onMouseLeave={handleHideHint} data-flat-id={97} d="M1180 2773H2985H3228.5V3393.5H3513L3531.5 3984L3882 4010V4279H2025V3984H1180V2773Z" fillOpacity="0.5" />
                                <path onClick={(e) => handleChooseFlat(!isVisible, e)} className={styles.path} onMouseEnter={handleChangeCurrentStage} onMouseLeave={handleHideHint} data-flat-id={48} d="M3228.5 3393.5V2788H4746V3987.5H3531.5V3393.5H3228.5Z" fillOpacity="0.5" />
                                <path onClick={(e) => handleChooseFlat(!isVisible, e)} className={styles.path} onMouseEnter={handleChangeCurrentStage} onMouseLeave={handleHideHint} data-flat-id={49} d="M1180 2778H2595V1926H2387.5V1629.5H1156L1180 2778Z" fillOpacity="0.5" />
                                <path onClick={(e) => handleChooseFlat(!isVisible, e)} className={styles.path} onMouseEnter={handleChangeCurrentStage} onMouseLeave={handleHideHint} data-flat-id={79} d="M3880 446.5H4783L4767 1664H3583.5V1782.5V1943H2957V216.5H3880V446.5Z" fillOpacity="0.5" />
